    ...
    <div class="grid">
        <div class="col-12">
            <div class="card docs">
                ...
                <p>FoodBurguer is an application template for Vue based on the <a href="https://cli.vuejs.org/" class="font-medium">Vue CLI</a> that provides out-of-the-box standard
...
yarn
                ...
                <p>Next step is running the application using the serve script and navigate to <i>http://localhost:8080/</i> to view the application.
                    That is it, you may now start with the development of your application using the FoodBurguer template.</p>
...
"npm run test:unit": Runs the tests.
                ...
                <h5>Dependencies</h5>
                <p>Dependencies of FoodBurguer are listed below and needs to be added to package.json.</p>
